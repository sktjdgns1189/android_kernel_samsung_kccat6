...
static struct wcd9xxx_mbhc_config mbhc_cfg = {
	...
	.insert_detect = true,
	.swap_gnd_mic = NULL,
#if (defined(CONFIG_MACH_LENTISLTE_SKT) || defined(CONFIG_MACH_LENTISLTE_KTT) || defined(CONFIG_MACH_LENTISLTE_LGT) || defined(CONFIG_SEC_TRLTE_JPN)|| defined(CONFIG_SEC_KCCAT6_PROJECT)) && !defined(CONFIG_SEC_FACTORY)
