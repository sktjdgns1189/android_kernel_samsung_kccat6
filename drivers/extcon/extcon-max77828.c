...
static void max77828_muic_start_check_hv(struct max77828_muic_info *info)
{
	 ...
	 * Set ADCMode = 0x00
	 */
	max77828_update_reg(client, MAX77828_MUIC_REG_CTRL4, 
			(0 << CTRL4_ADCMODE_SHIFT), CTRL4_ADCMODE_MASK);
...
static void max77828_muic_check_handshaking(struct max77828_muic_info *info)
{
	 ...
	 */
	if(((value & 0x0F) >= MVBUS_8V_9V) && ((value & 0x0F) <= MVBUS_9V_10V))
	{
	...
	} else if(((value & 0x0F) >= MVBUS_4V_5V) && ((value & 0x0F) <= MVBUS_5V_6V)) {
